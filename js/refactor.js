...
// My answer is [c]: z then y because x is never logged, eliminating that value option.
// Although y is the first value is the javascript order, setTimeout prevents that
// value from logging before z which has no delay. Thus the order, z then y.
...
// The function is setting speed to NaN when no parameter is given because
// javascript interprets no parameter as an empty string. Strings are not numbers
